<template>
  <view>
    <view class="car-input-container">
      ...
      >
        ...
        >
          ...
          <img v-if="maxNum - 1 == index" class="new-item-img" :src="xnyImgBase64" />
          {{ item }}
        </view>
      </view>
    </view>

    <view v-if="showKeyPop1" class="car-number-container">
    ...
    <view v-if="showKeyPop2" class="car-number-container">
      <view class="plate-close" @click="closeKeyboard"
        ><text class="plate-close-btn">关闭</text></view
      >
      <view class="plate-popup-list">
  ...
  .car-input-box {
    ...
    .car-input-item {
      ...
      .sel-item-line {
        ...
        left: 15%;
        height: 2px;
        background-color: var(--uvt-primary-color);
        width: 70%;
      }
      .new-item-img {
        position: absolute;
