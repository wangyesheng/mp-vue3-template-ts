<template>
  <view
    class="flex min-h-screen w-full justify-center bg-[radial-gradient(circle_at_18%_20%,#e0f2fe,#fdf4ff_70%)] px-0 py-6 text-slate-800"
  >
    <view class="flex w-full flex-col space-y-5 px-4 sm:px-5 md:w-[94vw] md:max-w-[960px]">
      <view>
        <HeroShowcase />
      </view>
      <view>
